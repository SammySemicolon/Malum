...
public class WaveChargerBlockEntity extends DirectionalRedstoneDiodeBlockEntity {
            ...
            if (timer >= Math.max(Math.round(frequency / 15f), 1)) {
                ...
                if (currentSignal == desiredSignal) {
                    ...
                    if (level instanceof ServerLevel) {
                        ...
                        level.playSound(null, getBlockPos(), SoundRegistry.WAVECHARGER_CHARGE.get(), SoundSource.BLOCKS, 0.3f, pitch);
