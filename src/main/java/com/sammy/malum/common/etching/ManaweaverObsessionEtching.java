...
public class ManaweaverObsessionEtching extends EtchingEffect {

    public ManaweaverObsessionEtching() {
        super(MalumEtchingEffectTypeRegistry.MANAWEAVERS_OBSESSION.get());
    }
    ...
    public Multimap<Holder<Attribute>, AttributeModifier> getAttributes(LivingEntity entity, Multimap<Holder<Attribute>, AttributeModifier> modifiers) {
        ...
        addAttributeModifier(modifiers, AttributeRegistry.SOUL_WARD_INTEGRITY, -0.25f, AttributeModifier.Operation.ADD_MULTIPLIED_TOTAL);
        return modifiers;
    }
}