...
public class ComponentHelper {
    ...
    public static Component positiveCurioEffect(String name, Object... args) {
        return Component.translatable("malum.effect.curio.positive", Component.translatable("malum.effect.curio." + name, args)).withStyle(ChatFormatting.BLUE);
    }

    public static Component negativeCurioEffect(String name, Object... args) {
        return Component.translatable("malum.effect.curio.negative", Component.translatable("malum.effect.curio." + name, args)).withStyle(ChatFormatting.RED);
    }
