...
public class CurioSpiritInfusionRecipes {
    ...
    public static void buildRecipes(RecipeOutput consumer) {
        ...
        new SpiritInfusionRecipeBuilder(ItemRegistry.RUNIC_BROOCH.get(), ItemRegistry.GLASS_BROOCH.get(), 1)
        ...
        new SpiritInfusionRecipeBuilder(ItemRegistry.ELABORATE_BROOCH.get(), ItemRegistry.GLUTTONOUS_BROOCH.get(), 1)
                .addExtraItem(ItemRegistry.ROTTING_ESSENCE.get(), 8)
                .addExtraItem(ItemRegistry.GRIM_TALC.get(), 4)
                .addSpirit(WICKED_SPIRIT, 32)
                .save(consumer);

        new SpiritInfusionRecipeBuilder(ItemRegistry.ORNATE_RING.get(), ItemRegistry.RING_OF_ESOTERIC_SPOILS.get(), 1)
        ...
        new SpiritInfusionRecipeBuilder(ItemRegistry.GILDED_RING.get(), ItemRegistry.RING_OF_CURATIVE_TALENT.get(), 1)
        ...
        new SpiritInfusionRecipeBuilder(ItemRegistry.GILDED_RING.get(), ItemRegistry.RING_OF_ALCHEMICAL_MASTERY.get(), 1)
        ...
        new SpiritInfusionRecipeBuilder(ItemRegistry.ORNATE_NECKLACE.get(), ItemRegistry.NECKLACE_OF_BLISSFUL_HARMONY.get(), 1)
        ...
        new SpiritInfusionRecipeBuilder(ItemRegistry.ORNATE_NECKLACE.get(), ItemRegistry.NECKLACE_OF_THE_NARROW_EDGE.get(), 1)
        ...
        new SpiritInfusionRecipeBuilder(ItemRegistry.ORNATE_NECKLACE.get(), ItemRegistry.NECKLACE_OF_THE_MYSTIC_MIRROR.get(), 1)
        ...
        new SpiritInfusionRecipeBuilder(ItemRegistry.ORNATE_RING.get(), ItemRegistry.RING_OF_DESPERATE_VORACITY.get(), 1)
        ...
        new SpiritInfusionRecipeBuilder(ItemRegistry.GILDED_BELT.get(), ItemRegistry.BELT_OF_THE_STARVED.get(), 1)
                .addExtraItem(Items.BONE, 4)
        ...
        new SpiritInfusionRecipeBuilder(ItemRegistry.GILDED_RING.get(), ItemRegistry.RING_OF_THE_HOARDER.get(), 1)
                .addExtraItem(SizedIngredient.of(Tags.Items.INGOTS_IRON, 6))
        ...
        new SpiritInfusionRecipeBuilder(ItemRegistry.ORNATE_RING.get(), ItemRegistry.RING_OF_THE_DEMOLITIONIST.get(), 1)
                .addExtraItem(SizedIngredient.of(Tags.Items.INGOTS_IRON, 6))
        ...
        new SpiritInfusionRecipeBuilder(ItemRegistry.GILDED_BELT.get(), ItemRegistry.BELT_OF_THE_PROSPECTOR.get(), 1)
        ...
        new SpiritInfusionRecipeBuilder(ItemRegistry.GILDED_BELT.get(), ItemRegistry.BELT_OF_THE_MAGEBANE.get(), 1)
                .addSpirit(WICKED_SPIRIT, 32)
                .addSpirit(ARCANE_SPIRIT, 16)
        ...
        new SpiritInfusionRecipeBuilder(ItemRegistry.RING_OF_ESOTERIC_SPOILS.get(), ItemRegistry.RING_OF_THE_ENDLESS_WELL.get(), 1)
        ...
        new SpiritInfusionRecipeBuilder(ItemRegistry.RING_OF_DESPERATE_VORACITY.get(), ItemRegistry.RING_OF_GRUESOME_CONCENTRATION.get(), 1)
        ...
        new SpiritInfusionRecipeBuilder(ItemRegistry.RING_OF_CURATIVE_TALENT.get(), ItemRegistry.RING_OF_GROWING_FLESH.get(), 1)
                .addExtraItem(ItemRegistry.NULL_SLATE.get(), 16)
                .addExtraItem(ItemRegistry.VOID_SALTS.get(), 8)
                .addSpirit(SACRED_SPIRIT, 16)
                .addSpirit(WICKED_SPIRIT, 16)
        ...
        new SpiritInfusionRecipeBuilder(ItemRegistry.NECKLACE_OF_THE_NARROW_EDGE.get(), ItemRegistry.NECKLACE_OF_THE_HIDDEN_BLADE.get(), 1)
                .addExtraItem(ItemRegistry.NULL_SLATE.get(), 16)
        ...
        new SpiritInfusionRecipeBuilder(ItemRegistry.NECKLACE_OF_THE_MYSTIC_MIRROR.get(), ItemRegistry.NECKLACE_OF_THE_WATCHER.get(), 1)
                .addExtraItem(ItemRegistry.NULL_SLATE.get(), 16)
                .addExtraItem(ItemRegistry.MALIGNANT_LEAD.get(), 1)
                .addSpirit(WICKED_SPIRIT, 32)
                .addSpirit(ARCANE_SPIRIT, 32)
        ...
        new SpiritInfusionRecipeBuilder(ItemRegistry.BELT_OF_THE_MAGEBANE.get(), ItemRegistry.BELT_OF_THE_LIMITLESS.get(), 1)
